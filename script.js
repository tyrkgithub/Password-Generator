...
function getPasswordOptions() {
 ...
 let characters = prompt("How many characters would you like your password to be? (Between 10 and 64)")
 if (characters < 10 || characters > 64){
  alert("Invailid. Please start again by pressing the 'Generate Password' button and choose a number between 10 and 64. Character length must be provided as a number.")
 } else {
